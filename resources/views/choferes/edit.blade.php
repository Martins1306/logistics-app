    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" name="apellido" class="form-control" 
                       value="{{ old('apellido', $chofer->apellido) }}" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" name="dni" class="form-control" 
                       value="{{ old('dni', $chofer->dni) }}" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select name="licencia_tipo" class="form-control" required>
                    ...
                    <option value="A1" {{ old('licencia_tipo', $chofer->licencia_tipo) == 'A1' ? 'selected' : '' }}>A1</option>
                    <option value="A2" {{ old('licencia_tipo', $chofer->licencia_tipo) == 'A2' ? 'selected' : '' }}>A2</option>
                    <option value="B" {{ old('licencia_tipo', $chofer->licencia_tipo) == 'B' ? 'selected' : '' }}>B</option>
                    <option value="C" {{ old('licencia_tipo', $chofer->licencia_tipo) == 'C' ? 'selected' : '' }}>C</option>
                    <option value="D" {{ old('licencia_tipo', $chofer->licencia_tipo) == 'D' ? 'selected' : '' }}>D</option>
                </select>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea name="observaciones" class="form-control" rows="3">{{ old('observaciones', $chofer->observaciones) }}</textarea>
            </div>
        </div>
    </div>

    <button type="submit" class="btn btn-success btn-sm">Actualizar Chofer</button>
