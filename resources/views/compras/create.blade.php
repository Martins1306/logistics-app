...
@section('content')
<div class="p-3">
    <h2><i class="fas fa-shopping-cart text-success"></i> Registrar Compra</h2>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb" style="background-color: transparent; padding: 0; font-size: 0.9rem;">
            ...
            <li class="breadcrumb-item active" style="color: #ccc;">Nueva</li>
        </ol>
    </nav>
    ...
    <form action="{{ route('compras.store') }}" method="POST" class="needs-confirmation" data-message="¿Confirmar compra? Esta acción aumentará el stock.">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="fecha_compra" class="form-control" value="{{ old('fecha_compra', now()->format('Y-m-d')) }}" required style="background-color: #333; border: 1px solid #555; color: #eee;">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="numero_factura" class="form-control" value="{{ old('numero_factura') }}" style="background-color: #333; border: 1px solid #555; color: #eee;">
            </div>
            <div class="col-md-6">
                <label class="form-label">Método de Pago</label>
                <input type="text" name="metodo_pago" class="form-control" value="{{ old('metodo_pago') }}" style="background-color: #333; border: 1px solid #555; color: #eee;">
            </div>
        </div>
